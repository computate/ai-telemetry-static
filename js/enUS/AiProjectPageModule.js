          ...
          document.querySelector('#Page_created')?.addEventListener('sl-change', (event) => {
            ...
            if(valid) {
              ...
              if(t) {
                ...
                patchAiProjectVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'pk:' + event.currentTarget.getAttribute('data-pk') }]
                    , 'setCreated', s
                    , event.currentTarget
